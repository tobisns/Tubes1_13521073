...
public class InputFrameController{
    ...
    private void initialize(){
        ...
        ObservableList<String> typeDropdown = FXCollections.observableArrayList(
                "", "Local Search", "Alpha-Beta Pruning", "Genetic Algorithm");
        this.botType.setItems(typeDropdown);
    ...
    private void play() throws IOException{
        if (this.isInputFieldValidated()){
            ...
            outputFC.getInput(this.player1.getText(), this.player2.getText(), this.numberOfRounds.getValue(),
                    this.botType.getValue(), this.isBotFirst.isSelected());
